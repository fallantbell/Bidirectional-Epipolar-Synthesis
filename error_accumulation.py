...
parser.add_argument("--dataset", type=str, default="realestate",
                    help="dataset type")
parser.add_argument("--name", type=str, default="exp_1_error",
                    help="experiments name")
parser.add_argument("--base", type=str, default="./configs/realestate/realestate_16x16_sine_cview_adaptive_error.yaml",
                    help="experiments name")
parser.add_argument("--data-path", type=str, default="/latent_opt_test/RealEstate10K_Downloader/",
                    help="data path")
parser.add_argument("--batch-size", type=int, default=1, help="the gpu only afford batch-size = 1")
parser.add_argument("--ckpt-iter", type=int, default=5000,
                    help="interval for visual the result")
parser.add_argument("--visual-iter", type=int, default=500,
                    help="interval for visual the result")
parser.add_argument("--max_iter", type=int, default=100001,
                    help="epochs for training")
parser.add_argument("--len", type=int, default=5, help="")
...
# first make the dir
model_dir = os.path.join("./experiments/", args.name)
visual_dir = os.path.join("./experiments/", args.name, "visual")
save_dir = os.path.join("./experiments/", args.name, "model")
...
if args.dataset == "realestate":
    # from src.data.realestate.realestate_abs import VideoDataset
    ...
    dataset = Re10k_dataset(data_root="../dataset",mode="finetune")
